...
{
    public class RaspiHidPortRfIdClient : BaseRfIdClient
    {
        ...
        public RaspiHidPortRfIdClient(RaspiHidPortInfo connectionData) : base(RfIdType.ComPort, connectionData)
        {
        }

        public RaspiHidPortRfIdClient(BaseRfIdInfo connectionData) : base(RfIdType.ComPort, connectionData)
        {
        }
