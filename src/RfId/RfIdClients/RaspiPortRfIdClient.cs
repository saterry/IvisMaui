...
{
    public class RaspiPortRfIdClient : BaseRfIdClient
    {
        ...
        public RaspiPortRfIdClient(RaspiPortInfo connectionData) : base(RfIdType.ComPort, connectionData)
        {
        }

        public RaspiPortRfIdClient(BaseRfIdInfo connectionData) : base(RfIdType.ComPort, connectionData)
        {
        }
